...
export async function GET(_req: NextRequest, { params }: Ctx) {
  ...
  try {
    ...
    if (error) {
      ...
      return Response.json({ error: 'Unable to list media files' }, { status: 500 })
    }
    ...
    return Response.json({ error: 'Unable to load media files at this time' }, { status: 500 })
  }
}
...
export async function POST(req: NextRequest, { params }: Ctx) {
  try {
    ...
    if (error) {
      ...
      return Response.json({ error: 'Unable to upload media file' }, { status: 500 })
    }
    ...
    return Response.json({ error: 'Unable to upload media file at this time' }, { status: 500 })
  }
}
...
export async function DELETE(req: NextRequest, { params }: Ctx) {
  try {
    ...
    if (error) {
      ...
      return Response.json({ error: 'Unable to delete media file' }, { status: 500 })
    }
    ...
    console.error('Failed to delete project media', err)
    return Response.json({ error: 'Unable to delete media file at this time' }, { status: 500 })
  }
}
